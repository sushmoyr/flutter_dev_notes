...
class _MaterialScaffoldState extends State<MaterialScaffold> {
  ...
  @override
  void didUpdateWidget(covariant MaterialScaffold oldWidget) {
    if (oldWidget.hideFabOnScroll != widget.hideFabOnScroll) {
      _showFab = widget.hideFabOnScroll ? _showFab : true;
    }
